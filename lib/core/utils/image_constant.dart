class ImageConstant {
  ...
  // Sign up images
  static String imgNounFlower6448393 = '$imagePath/img_noun_flower_6448393.svg';

  static String imgTulips = '$imagePath/img_tulips.svg';
  ...
  // Facial images
  static String imgAndroidStatusBars = '$imagePath/img_android_status_bars.png';

  static String imgRectangle769x66 = '$imagePath/img_rectangle_7_69x66.png';

  static String imgVector1 = '$imagePath/img_vector_1.svg';

  static String imgLogoswhatsappicon = '$imagePath/img_logoswhatsappicon.png';

  static String imgFluentcall24filled = '$imagePath/img_fluentcall24filled.svg';
  ...
  static String imgFrame2109 = '$imagePath/img_frame_2109.svg';

  static String imgBattery = '$imagePath/img_battery.svg';
  ...
  static String imgEllipse560x60 = '$imagePath/img_ellipse_5_60x60.png';
  ...
  static String imgNavContact = '$imagePath/img_nav_contact.svg';

  static String imgNavAccount = '$imagePath/img_nav_account.svg';

  static String imgGetpaidstock1 = '$imagePath/img_getpaidstock_1.png';

  static String imgLogo = '$imagePath/img_logo.svg';

  static String imgUser = '$imagePath/img_user.svg';

  static String imgWifiBlack900 = '$imagePath/img_wifi_black_900.svg';

  static String imgSettingsBlack900 = '$imagePath/img_settings_black_900.svg';

  static String imgBatteryBlack900 = '$imagePath/img_battery_black_900.svg';
